                    ...
                    <div class="row g-3">
                        ...
                        <div class="col-lg-12">
                            <div class="mb-3">
                                ...
                                <select id="esigibilita_iva" name="esigibilita_iva" class="form-control" required data-choices data-choices-search-false>
                                    <option value="I" <?php echo ($c->esigibilita_iva == 'I')?'selected':'' ?>>Immediata</option>
                                    <option value="D" <?php echo ($c->esigibilita_iva == 'D')?'selected':'' ?>>Differita</option>
                                    <option value="S" <?php echo ($c->esigibilita_iva == 'S')?'selected':'' ?>>Split Payment</option>
                                </select>
                            </div>
                        </div>
                        ...
                        <div class="col-md-12 mb-2">
                            <div class="form-check form-switch">
                                <input class="form-check-input" type="checkbox" id="esportatore_abituale_<?php echo $c->id ?>" name="esportatore_abituale" value="1" <?php echo (!empty($c->esportatore_abituale)?'checked':'') ?>>
                                <label class="form-check-label" for="esportatore_abituale_<?php echo $c->id ?>">Esportatore abituale</label>
                            </div>
                        </div>

                        <div class="col-md-6">
                            <label class="form-label">Numero protocollo</label>
                            <input type="text" name="dich_intento_protocollo" value="<?php echo $c->dich_intento_protocollo ?? '' ?>" class="form-control" placeholder="Es. 08060971890123456-000001">
                        </div>
                        <div class="col-md-6">
                            <label class="form-label">Data dichiarazione</label>
                            <input type="date" name="dich_intento_data" value="<?php echo $c->dich_intento_data ?? '' ?>" class="form-control">
                        </div>
                        <div class="col-md-4">
                            <label class="form-label">Validità da</label>
                            <input type="date" name="dich_intento_validita_da" value="<?php echo $c->dich_intento_validita_da ?? '' ?>" class="form-control">
                        </div>
                        <div class="col-md-4">
                            <label class="form-label">Validità a</label>
                            <input type="date" name="dich_intento_validita_a" value="<?php echo $c->dich_intento_validita_a ?? '' ?>" class="form-control">
                        </div>
                        <div class="col-md-4">
                            <label class="form-label">Importo plafond (€)</label>
                            <input type="number" name="dich_intento_importo" value="<?php echo $c->dich_intento_importo ?? '' ?>" class="form-control" step="0.01" placeholder="0.00">
                        </div>
