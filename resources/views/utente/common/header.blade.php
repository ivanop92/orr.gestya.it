...
-->
                    <div class="dropdown ms-sm-3 header-item topbar-user" style="height: 40px;">
                        ...
                        <div class="dropdown-menu dropdown-menu-end">
                            ...
                            @for($a = date('Y'); $a >= 2022; $a--)
                            <a class="dropdown-item" href="/utente/cambia_anno/{{ $a }}"><i class="mdi mdi-account-circle text-muted fs-16 align-middle me-1"></i> <span class="align-middle">{{ $a }}</span></a>
                            @endfor
    ...
    <div class="app-menu navbar-menu">
        ...
        <div class="navbar-brand-box">
            ...
            <!-- Light Logo-->
            <a href="/utente/index" class="logo logo-light">
                    <span class="logo-sm">
                            <img src="/logo_gestya.jpg" alt="" height="22">
                    </span>
                <span class="logo-lg">
