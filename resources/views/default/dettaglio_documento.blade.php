                        ...
                        <div class="col-lg-12">
                            <div class="card-body p-4">
                                <div class="row g-3">
                                    ...
                                    <div class="col-lg-3 col-6">
                                        <p class="text-muted mb-2 text-uppercase fw-semibold">Commessa</p>
                                        @php
                                            $commessa = DB::table('commesse')->where('id', $dotes->id_commessa)->first();
                                        @endphp
                                        @if($commessa)
                                            <h5 class="fs-14 mb-0">
                                                {{ $commessa->codice_commessa }} - {{ $commessa->descrizione }}
                                                <a href="{{ url('utente/commesse/'.$commessa->id.'/dashboard') }}" class="btn btn-sm btn-info ms-2">
                                                    <i class="ri-dashboard-line"></i> Dashboard
                                                </a>
                                            </h5>
                                        @else
                                            <h5 class="fs-14 mb-0">ID: {{ $dotes->id_commessa }}</h5>
                                        @endif
                                    </div>
                                    @endif
                                    <div class="col-lg-3 col-6">
