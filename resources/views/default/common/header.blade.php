                ...
                <div class="d-flex">
                    <div class="navbar-brand-box horizontal-logo">
                        ...
                        <span class="logo-sm">
                            ...
                            <span class="logo-lg">
                            <img src="/logo_gestya.jpg" alt="" height="17">
                        </span>
                        </a>
    ...
    <div class="app-menu navbar-menu">
        ...
        <div class="navbar-brand-box">
            ...
            <a href="/admin/index" class="logo logo-dark">
                    <span class="logo-sm">
                            <img src="/icona.png" alt="" height="22">
                    </span>
                <span class="logo-lg">
    ...
    <div class="main-content">
        ...
        <script>
            document.addEventListener('DOMContentLoaded', function() {
                // Funzione per mostrare la notifica Toastr
                function mostraNotifica(messaggio) {
                    ...
                    toastr.warning(messaggio);
                }

                // Funzione di controllo del riordino
                function controlloRiordino() {
                    fetch("{{ route('controllo.riordino') }}")
                        .then(response => response.json())
                        .then(data => {
                            if (data.messaggio) {
                                // Mostra la notifica se il messaggio non è vuoto
                                mostraNotifica(data.messaggio);
                            }
                        })
                        .catch(error => console.error("Errore nel controllo punto di riordino:", error));
                }

                // Esegui il controllo del riordino al caricamento della pagina
                controlloRiordino();

                // Esegui il controllo periodico ogni 5 minuti
                setInterval(controlloRiordino, 300000); // 300000 ms = 5 minuti
            });
        </script>
