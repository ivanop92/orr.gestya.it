                ...
                @foreach ($aziende as $azienda)
                    <tr>
                        ...
                        <td>
                            ...
                            <form id="loginForm-{{$azienda->id_utente}}" action="{{asset('admin/effettua_login')}}" method="post">
                                <input type="hidden" name="id_utente" value="{{$azienda->id_utente}}">
                                <input type="hidden" name="id_super_admin" value="{{$utente->id}}">
                                <input type="hidden" name="effettua_login_admin" value="effettua">
                                <button data-nome="{{$azienda->nome}}" data-cognome="{{$azienda->cognome}}" type="submit" class="btn btn-success custom-toggle mt-1">
