                        ...
                        <li class="nav-item">
                            ...
                            <div class="collapse menu-dropdown" id="sidebarCicloAttivo">
                                <ul class="nav nav-sm flex-column">
                                    ...
                                    <!--
                                    <li class="nav-item">
                                        <a href="/utente/fatture/2024" class="nav-link" data-key="t-level-2.1">Fatture</a>
                                    </li>-->
            ...
            <li class="nav-item">
                ...
                <div class="collapse menu-dropdown" id="sidebar_magazzino">
                    <ul class="nav nav-sm flex-column">
                        ...
                        <li class="nav-item">
                            <a href="/utente/mg/trasferimento_mg" class="nav-link" data-key="t-analytics">Trasferimento</a>
                        </li>
